...
# title           :moviedb_search.py
# description     :MovieDBSearch menu definition.
# author          :Eric Kimsey
# usage           :
# notes           :
# python_version  :3.5+
...
class MovieDBSearch(TextEntry):
    TITLE = 'Search MovieDB text fields'

    def __init__(self):
        """
        Create MovieDBSearch menu.
        """
        prompt = 'Search term: '
        special_options = {
            'B': 'Back',
